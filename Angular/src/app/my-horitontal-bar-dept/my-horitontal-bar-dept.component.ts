...
@Component({
  selector: 'app-my-horitontal-bar-dept',
  templateUrl: './my-horitontal-bar-dept.component.html',
  styleUrls: ['./my-horitontal-bar-dept.component.css']
})
export class MyHoritontalBarDeptComponent implements OnInit {
...
loadChartBar(){
		...
		res => {
	        ...
	        for(let i=0;i<this.barChartLabels.length;i++){
	        	newDataObject.label.push(this.barChartLabels[i]);
	        	newDataObject.data.push(this.barChartData[0].data[i]);
	        }
